...
namespace Fuse.Navigation
{
	...
	*/
	public abstract class WhileNavigationTrigger : WhileTrigger
	{
		...
		*/
		...
		internal void GoProgress(double progress)
		{
	...
	*/
	public class WhileActive : WhileNavigationTrigger
	{
		...
		{
			GoProgress(InvertProgress(NavContext.GetPageState(PageContext).Progress));
		}
	...
	*/
	public class WhileInactive : WhileNavigationTrigger
	{
		protected override void ForceUpdate()
		{
			GoProgress(Math.Abs(NavContext.GetPageState(PageContext).Progress));
		}
	...
	*/
	public class WhileInExitState : WhileNavigationTrigger
	{
		protected override void ForceUpdate()
		{
			GoProgress(-NavContext.GetPageState(PageContext).Progress);
		}
