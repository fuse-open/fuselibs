...
namespace Experimental.Http
{
	...
	abstract class Loader
	{
		...
		protected abstract void PrepareRequest( HttpMessageHandlerRequest request );
		...
		protected abstract void CompleteLoading( HttpMessageHandlerRequest resp );
		...
		protected abstract bool LoadCacheRaw(ICacheReader record);
