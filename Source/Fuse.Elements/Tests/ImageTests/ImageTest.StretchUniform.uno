...
namespace Fuse.Test
{
	public partial class ImageTests : TestBase
	{
		...
		public void StretchUniformTest()
		{
			...
			TestImageLayout(int2(1586, 896), panel.Image1, float2(896), float2((1586-896)/2f, 0),
			float2(1586, 896), float2(0));
			TestImageLayout(int2(1586, 896), panel.Image2, float2(896), float2((1586-896)/2f, 0),
			float2(1586, 896), float2(0));

			TestImageLayout(int2(114, 833), panel.Image1, float2(114), float2(0, (833-114)/2f),
			float2(114, 833), float2(0));
			TestImageLayout(int2(114, 833), panel.Image2, float2(114), float2(0, (833-114)/2f),
			float2(114, 833), float2(0));
		}
		...
		public void StretchUniformSmallTest()
		{
			...
			TestImageLayout(int2(563, 39), panel.Image1, float2(39), float2((563-39)/2f, 0),
			float2(563, 39), float2(0));
			TestImageLayout(int2(563, 39), panel.Image2, float2(39), float2((563-39)/2f, 0),
			float2(563, 39), float2(0));

			TestImageLayout(int2(55, 29), panel.Image1, float2(29), float2((55-29)/2f, 0),
			float2(55, 29), float2(0));
			TestImageLayout(int2(55, 29), panel.Image2, float2(29), float2((55-29)/2f, 0),
			float2(55, 29), float2(0));

			TestImageLayout(int2(23, 43), panel.Image1, float2(23), float2(0, (43-23)/2f),
			float2(23, 43), float2(0));
			TestImageLayout(int2(23, 43), panel.Image2, float2(23), float2(0, (43-23)/2f),
			float2(23, 43), float2(0));
		}
		...
		public void StretchUniformUpOnlyTest()
		{
			...
			TestImageLayout(int2(1586, 896), panel.Image1, float2(896), float2((1586-896)/2f, 0),
			float2(1586, 896), float2(0));
			TestImageLayout(int2(527, 896), panel.Image1, float2(527), float2(0, (896-527)/2f),
		...
		public void StretchUniformDownOnlySmallTest()
		{
			var panel = new StackPanelScene11();
			_root.Children.Add(panel);
			_root.Layout(int2(563, 39));

			TestImageLayout(int2(563, 39), panel.Image1, float2(39),
			float2((563-39)/2f, 0),
			float2(563, 39), float2(0));
			TestImageLayout(int2(114, 833), panel.Image1, float2(114),
			float2(0, (833-114)/2f),
			float2(114, 833), float2(0));
			TestImageLayout(int2(55, 29), panel.Image1, float2(29),
			float2((55-29)/2f, 0),
			float2(55, 29), float2(0));
			TestImageLayout(int2(23, 43), panel.Image1, float2(23),
			float2(0, (43-23)/2f),
			float2(23, 43), float2(0));
		}
	}
