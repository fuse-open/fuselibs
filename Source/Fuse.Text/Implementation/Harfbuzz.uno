...
namespace Fuse.Text.Implementation
{
	...
	[extern((PInvoke || CMake) && HOST_OSX) Require("LinkDirectory", "@('../harfbuzz/lib/OSX':Path)")]
	[extern((PInvoke || CMake) && HOST_OSX) Require("Xcode.Framework", "CoreText")]
	...
	[extern((PInvoke || MSVC) && HOST_WINDOWS) Require("LinkDirectory", "@('../harfbuzz/lib/Windows':Path)")]
