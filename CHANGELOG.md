...
## Gesture
- The experimental `IGesture` interface has changed. The `Significance`, `Priority` and `PriotityAdjustment` have been merged into the single `GetPriority` function.
